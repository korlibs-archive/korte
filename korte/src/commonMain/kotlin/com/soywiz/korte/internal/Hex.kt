...
internal val List<String>.unhexIgnoreSpaces get() = joinToString("").unhexIgnoreSpaces
internal val String.unhexIgnoreSpaces get() = this.replace(" ", "").replace("\n", "").replace("\r", "").unhex
