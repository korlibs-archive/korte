...
internal fun Int.toStringUnsigned(radix: Int): String {
	var temp = this
	return when (temp) {
		0 -> "0"
		else -> {
...
internal fun Long.toStringUnsigned(radix: Int): String {
	var temp = this
	return when (temp) {
		0L -> "0"
		else -> {
...
internal infix fun Int.udiv(that: Int) = IntEx.divideUnsigned(this, that)
internal infix fun Int.urem(that: Int) = IntEx.remainderUnsigned(this, that)

internal infix fun Long.udiv(that: Long) = LongEx.divideUnsigned(this, that)
internal infix fun Long.urem(that: Long) = LongEx.remainderUnsigned(this, that)

internal object LongEx {
