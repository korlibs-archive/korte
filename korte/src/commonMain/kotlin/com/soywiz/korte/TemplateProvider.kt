...
interface TemplateProvider {
	class NotFoundException(val template: String) : RuntimeException()

	suspend fun get(template: String): String?
}

suspend fun TemplateProvider.getSure(template: String) = get(template) ?: throw TemplateProvider.NotFoundException(template)
